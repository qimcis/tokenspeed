...
# Vendored from flash_attn.cute.flash_fwd_combine (tokenspeed-fa4) with a
# `use_pdl` launch option; kernel body unchanged.
import math
...
from . import fmha_bias_helper  # noqa: F401
